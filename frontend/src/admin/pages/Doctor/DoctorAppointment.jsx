...
import PatientHealthRecordsModal from '../../components/PatientHealthRecordsModal';

const DoctorAppointment = () => {
  const { dToken, appointments, getAppointments, completeAppointment, cancelAppointment, backendUrl } =
                ...
                <div>
                  ...
                  <button
                    onClick={() => setSelectedPatient({
                      id: item.userId,
                      name: item.userData?.name || 'Unknown'
                    })}
